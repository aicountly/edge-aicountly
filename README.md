...
Edge for Aicountly — a React single-page app built with Vite and TypeScript,
with a small PHP API alongside it. Both halves deploy to cPanel.

| Environment | App | API |
| --- | --- | --- |
| Production | https://edge.aicountly.com | https://edge.aicountly.com/api |
| Sandbox | https://edge.gh.aicountly.com | https://edge.gh.aicountly.com/api |
...
(`https://edge.gh.aicountly.com/api`) so the token exchange has somewhere to
