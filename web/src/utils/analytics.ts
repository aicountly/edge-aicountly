/**
 * Google Analytics 4 (gtag) for edge.aicountly.com.
 *
 * Set at build time: VITE_GA4_SAAS_EDGE_MEASUREMENT_ID=G-…
 * Flow backend: GA4_PROPERTY_ID_SAAS_EDGE (numeric property ID).
 */
...
const GA4_ID: string =
  import.meta.env.VITE_GA4_SAAS_EDGE_MEASUREMENT_ID ||
